$(document).ready(function () {
  ...
  $("#rsvp-form").on("submit", function (e) {
    ...
    // 123122313123
    if (
      MD5($("#invite_code").val()) !== "f4e97bc5cb3f1a455b9dbc35de034ac9" &&
      MD5($("#invite_code").val()) !== "f4e97bc5cb3f1a455b9dbc35de034ac9"
    ) {
      $("#alert-wrapper").html(
        alert_markup(
...
// Google map\
// 60.0538547672718, -151.03819825741246
function initMap() {
  var location = { lat: 60.0538547672718, lng: -151.03819825741246 };
...
function initBBSRMap() {
  var la_fiesta = { lat: 60.0538547672718, lng: -151.03819825741246 };
  var map = new google.maps.Map(document.getElementById("map-canvas"), {
    zoom: 15,
    center: la_fiesta,
    scrollwheel: false,
